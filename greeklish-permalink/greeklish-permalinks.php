...
Author: Panagiotis Kontogiannis, elpak
...
if( ! class_exists( 'Trans_Plugin' ) ):
...

    {
        ...
        public function __construct() {
            ...
            add_action( 'admin_init', array($this, 'auto_transliterate_links') );
            add_action( 'rest_api_init', array($this, 'auto_transliterate_links') );
        ...
        public function cyrtrans_ajax_old() {
            ...
            if (!current_user_can('manage_options') || !wp_verify_nonce($_POST['nonce'], 'cyrtrans_ajax_old')) {
                wp_send_json_error(["message" => "Δεν έχετε άδεια να το κάνετε αυτό."], 403);
                exit();
            }
