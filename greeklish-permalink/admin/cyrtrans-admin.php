            ...
            <div id="cyrtrans_general" class="wptrans-tab-in js-wptrans-tab-item active">
                ...
                <p>
                    ...
                    <ol>
                        ...
                        <li>Αφαίρεση των stop λέξεων από τη διεύθυνση url (Θεωρείτε ότι δεν συνεισφέρουν στις μηχανές αναζήτησης). </li>
